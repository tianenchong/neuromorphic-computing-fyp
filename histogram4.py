...
def update(i):
	...
	if i == 0:
		...
		mweights = [ lim(w,i) for w in weights]
		ax.set_title('limiting ... boundaries [{:.4f}, {:.4f}], Scaled R = {:d}'.format(1/(3*i),1/i,i),fontsize=15)
...
if __name__ == '__main__':
	...
	if save == 1:
		anim.save('limit.gif', dpi=80, writer='imagemagick')
	else:
		plt.show()
